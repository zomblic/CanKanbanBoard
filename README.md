...
- [Issues and Bugs](#issues-and-bugs)
  ...
  [!Render](https://cankanbanboard.onrender.com)

  
Need to make a list? Like things organized? Well, come on in and get started!
 ...
 Or... just click on this link: [https://cankanbanboard.onrender.com](https://cankanbanboard.onrender.com).
...
In your terminal, the farthest out folder, meaning the folder that contains all the code, open your terminal and type 'npm i'. Wait a few mintues as all the dependencies install, including vite. Still in the terminal, type 'npm run start:dev' it will kickstart and automatically load. Type in the city name and you're done!
  ...
  ## <span style="color:rgb(225, 112, 112);">Credits</span>
    ...
    Classmates for forming study groups to problem solve and figure it out -- thanks to Zach M and Nick D for helping with debugging!
    Tutors (Ainsley) and TAs for being patient and helping us out,
